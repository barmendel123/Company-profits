...
public class JobPreference implements Initializable
{
	...
	public void initialize(URL arg0, ResourceBundle arg1) 
	{
		...
		{
			if(Employee.Employees.get(i).GetJob().equals("Junior"))
				profit=profit+Employee.Employees.get(i).GetEfficiency(8,17);
			else
				profit=profit+Employee.Employees.get(i).GetEfficiency();
		}
